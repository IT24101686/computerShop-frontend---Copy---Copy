    ...
    return (
        <div className="min-h-screen bg-primary">
            ...
            <nav className="bg-secondary px-8 py-4 flex items-center justify-between shadow-lg">
                <span className="text-accent font-extrabold text-xl">📦 Supplier Dashboard</span>
            ...
            <div className="max-w-6xl mx-auto p-8">
                <h1 className="text-3xl font-bold text-secondary mb-2">Supplier Panel 📦</h1>
                <p className="text-secondary/60 mb-8">Manage your supplies, view stock levels and submit supply orders.</p>

                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    {[
                        { label: "Add Supply", icon: "➕", path: "/supplier/add", desc: "Submit new stock supply" },
                        { label: "My Supplies", icon: "📋", path: "/supplier/list", desc: "View your supply history" },
                        { label: "Stock Requests", icon: "🚚", path: "/supplier/requests", desc: "View incoming stock requests" },
